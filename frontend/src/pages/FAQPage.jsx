...
const FAQ = () => {
  ...
  return (
    <div className={`${styles.section} my-8`}>
      <h2 className="font-bold text-gray-900 mb-8 text-3xl">FAQ</h2>
          ...
          {activeTab === 1 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                We typically process and ship orders withon 1-2 business
                days.Depending on your loaction,it can take an additional 2-7
